...
export const definition: ToolDefinition = {
  name: "thoughts_review",
  description: "Generate a structured summary of thoughts captured over a time period. Returns counts, breakdowns, people, topics, open action items, and thought listings grouped by type.",
  schema: {
    days: z.number().optional().default(7).describe("Number of days to review"),
  },
  handler: (deps, params) => weeklyReview(deps.supabase, params as WeeklyReviewParams),
};
