...
export const definition: ToolDefinition = {
  ...
  schema: {
    ...
    recency_halflife_days: z
      ...
      .optional()
      .default(30)
      .describe("Half-life in days for recency decay (default 30). A 30-day-old thought scores 0.5x."),
    ...
    apply_contradiction_penalty: z
      ...
      .optional()
      .default(true)
      .describe("Apply a 0.7 scoring penalty to thoughts involved in open contradictions (default true)."),
  },
