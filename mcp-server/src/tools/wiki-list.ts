...
export async function wikiList(supabase: SupabaseClient, params: WikiListParams): Promise<string> {
...
export const definition: ToolDefinition = {
  ...
  schema: {
    limit: z.number().optional().default(50).describe('Max pages to return (1..200, default 50)'),
    since: z
      .string()
      .optional()
      .describe('ISO timestamp. If set, only return pages compiled at or after this time.'),
  },
  handler: (deps, params) => wikiList(deps.supabase, params as unknown as WikiListParams),
};
